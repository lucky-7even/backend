...
function onConnected() {
    fetch('api/v1/chatRooms/' + chatRoomId, {
        method: 'GET',
        cache: 'no-cache',
    })
    ...
    stompClient.send(`/app/${chatRoomId}/addUser`, {}, JSON.stringify({sender: username, type: 'JOIN'}))
...
function sendMessage(event) {
    ...
    if(messageContent && stompClient) {
        ...
        stompClient.send(`/app/${chatRoomId}/sendMessage`, {}, JSON.stringify(chatMessage));
        messageInput.value = '';
    }
